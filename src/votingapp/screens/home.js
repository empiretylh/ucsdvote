      ...
      <Card.Body>
        ...
        <Link
          ...
          onClick={() => {
            ...
            localStorage.setItem('votingcode',item.votingcode)
          }}
      ...
      <Container>
        ...
        >
          ...
          >
            ...
            <Modal.Footer>
              <Button variant={"danger"} onClick={(e) => setCShow(false)}>
                Discard
              </Button>
              <Button
                variant={"primary"}
              ...
              <div style={{ display: "flex", flexDirection: "row" }}>
                ...
                >
                  <QRCode
                    ...
                    viewBox={`0 0 256 256`}
                  />
                  <h4 style={{ textAlign: "center" }}>{votingcode}</h4>
                </div>
                <div style={{ marginLeft: 10 }}>
                  ...
                  <p>
                    You need to save your voting code and QR Code to access
                    other people to connect our voting system.
                  </p>
                </div>
              </div>
              <Modal.Footer>
                <Button variant={"primary"}>Save QR Code</Button>
                <Button variant={"danger"} onClick={() => setsShow(false)}>
                  Close
                </Button>
              </Modal.Footer>
            </Modal.Body>
            ...
            <Modal.Body>
              <div style={{ display: "flex", flexDirection: "row" }}>
                <div style={{ marginLeft: 10 }}>
                  ...
                  <p style={{ color: "black" }}>
                    Its will delete all the datas that are belong to this
                    votingcode.
                  </p>
                </div>
              </div>
          ...
          {v_data.isFetching ? (
            <img src={IMAGE.loading} style={{ width: 50, height: 50 }} />
          ) : (
            <div className={"voting_card"}>
              ...
              <Button
                style={{ minWidth: 185, minHeight: 185 }}
                variant="primary"
